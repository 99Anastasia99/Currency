...
ActiveRecord::Schema.define(version: 2019_11_12_214722) do
  ...
  create_table "converters", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
