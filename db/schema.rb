...
ActiveRecord::Schema.define(version: 20_191_123_074_220) do
  create_table 'admins', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.index %w[invited_by_type invited_by_id], name: 'index_admins_on_invited_by_type_and_invited_by_id'
  ...
  create_table 'cashiers', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.index %w[invited_by_type invited_by_id], name: 'index_cashiers_on_invited_by_type_and_invited_by_id'
